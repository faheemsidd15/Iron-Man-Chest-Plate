	...
	<SvgContainer>
		...
		>
			<defs>
				...
				/>
				<path d="M320 466.91l-21.66-2.01-24.08-6.37-3.21-5.61 23.21-34.96L320 466.91z" id="left_bottom_piece" />
				<path d="M320 467.12l21.66-2.02 24.08-6.36 3.21-5.61-23.21-34.96L320 467.12z" id="right_bottom_piece" />
				<path d="M250 285.09l65.04 108.39v40.56l-97.9-168.53L250 285.09z" id="right_center_piece" />
				<path d="M390.79 285.31l-65.05 108.4v40.56l97.91-168.54-32.86 19.58z" id="left_center_piece" />
				<path d="M383.83 277.87l-126.41.56-34.87-20.71 194.9 1.9-33.62 18.25z" id="top_center_piece" />
				<path
			...
			<g mask="url(#prefix__d)">
				<use href="#inner_ring" fillOpacity={0} stroke="#11059b" strokeWidth={40} />
			</g>
			...
			<g>
				...
				<g clipPath="url(#prefix__s)">
					<use href="#prefix__b" fillOpacity={0} stroke="#080000" strokeWidth={10} />
				</g>
				<g>
					<filter
						id="prefix__t"
